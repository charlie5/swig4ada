...
DllExport void SWIGSTDCALL SWIGRegisterExceptionCallbacks_example (SWIG_AdaExceptionCallback_t systemException,
...
extern "C" 
#endif
DllExport void SWIGSTDCALL SWIGRegisterStringCallback_example(SWIG_AdaStringHelperCallback callback) {
...
extern "C" {
#endif
DllExport void * SWIGSTDCALL Ada_new_foo (
  )
{
  void * jresult ;
  foo *result = 0 ;
...
DllExport void SWIGSTDCALL Ada_delete_foo (
  void * jarg1
  )
{
  foo *arg1 = (foo *) 0 ;
