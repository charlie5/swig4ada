...
DllExport void SWIGSTDCALL SWIGRegisterExceptionCallbacks_string_example (SWIG_AdaExceptionCallback_t systemException,
...
extern "C" 
#endif
DllExport void SWIGSTDCALL SWIGRegisterStringCallback_string_example(SWIG_AdaStringHelperCallback callback) {
...
extern "C" {
#endif
DllExport int SWIGSTDCALL Ada_std_string_Size (
  )
{
  int jresult ;
  int result;
  
  result = (int)std_string_Size();
  jresult = result; 
...
DllExport void SWIGSTDCALL Ada_foo (
  std::string jarg1
  )
{
  std::string arg1 ;
...
DllExport void SWIGSTDCALL Ada_fooey (
  std::string* jarg1
  )
{
  std::string *arg1 = 0 ;
...
DllExport void * SWIGSTDCALL Ada_new_aaa (
  )
{
  void * jresult ;
  aaa *result = 0 ;
...
DllExport void SWIGSTDCALL Ada_delete_aaa (
  void * jarg1
  )
{
  aaa *arg1 = (aaa *) 0 ;
