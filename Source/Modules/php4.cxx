...
char cvsroot_php4_cxx[] = "$Id: php4.cxx 10453 2008-05-15 21:18:44Z wsfulton $";
...
public:
  ...
  void create_extra_files(String *outfile) {
    ...
    Printf(f_extra, "# $Id: php4.cxx 10453 2008-05-15 21:18:44Z wsfulton $\n\n" "LTLIBRARY_NAME          = %s.la\n", module);
    ...
    Printf(f_extra, "dnl $Id: php4.cxx 10453 2008-05-15 21:18:44Z wsfulton $\n");
    Printf(f_extra, "dnl ***********************************************************************\n");
