...
// #define GNAT_ENABLED      // comment this out when not using a gcc/gnat enabled compiler
...
int main(int margc, char **margv) {
  ...
  adafinal();
#else
  delete dl;       // for gnat ... deletion is done in Ada during adafinal().
#endif
