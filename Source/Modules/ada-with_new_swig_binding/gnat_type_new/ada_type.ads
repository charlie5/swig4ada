...
is
   ...
   function  depends_on              (Self : access Item;   a_Type : in ada_Type.view) return Boolean   is abstract;
   function  depends_directly_on     (Self : access Item;   a_Type : in ada_Type.view) return Boolean   is abstract;

   function  depends_on              (Self : access Item;   a_Package : access ada_Package.item'Class) return Boolean   is abstract;
