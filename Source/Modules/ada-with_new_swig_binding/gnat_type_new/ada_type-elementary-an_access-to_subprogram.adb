...
--        log ("c_type.depends_on ~ Self.Name: '" & self.name & "'     a_Declarable.Name: '" & a_Declarable.Name & "'");
      ...
      return self.accessed_subProgram.depends_on (a_Type);
   end depends_on;
...
--        log ("c_type.depends_on ~ Self.Name: '" & self.name & "'     a_Declarable.Name: '" & a_Declarable.Name & "'");
      ...
      return self.accessed_subProgram.depends_directly_on (a_Type);
   ...
   is
   begin
      return self.accessed_subProgram.depends_on (a_Package);
   end depends_on;
