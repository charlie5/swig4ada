   ...
   begin
      ...
      swigg_c_import
        .Language_main (self.swigCPtr_Language,
                        ...
                        Standard.system.Address (getCPtr (argv)));
   end main;
   ...
   begin
      ...
      return Integer (swigg_c_import
                      .Language_unrollVirtualMethods_SWIG_0 (self.swigCPtr_Language,
                        Standard.system.Address (getCPtr (n)),
                        Standard.system.Address (getCPtr (parent)),
                        Standard.system.Address (getCPtr (vm)),
                        Standard.interfaces.c.Int (default_director),
                        Standard.system.Address (getCPtr (virtual_destructor)),
   ...
   begin
      ...
      return Integer (swigg_c_import
                      .Language_classDirectorMethod (self.swigCPtr_Language,
                        Standard.system.Address (getCPtr (n)),
                        Standard.system.Address (getCPtr (parent)),
                        Standard.system.Address (getCPtr (super))));
   ...
   begin
      ...
      return Integer (swigg_c_import
                      .Language_validIdentifier (self.swigCPtr_Language,
                        Standard.system.Address (getCPtr (s))));
   ...
   begin
      ...
      swigg_c_import
        .Language_setOverloadResolutionTemplates (self.swigCPtr_Language,
                                                  Standard.system.Address (getCPtr (argc)),
                                                  Standard.system.Address (getCPtr (argv)));
   ...
   begin
      ...
      swigg_c_import
        .set_Language_none_comparison (self.swigCPtr_Language,
                                       Standard.system.Address (getCPtr (none_comparison)));
   ...
   begin
      ...
      swigg_c_import
        .set_Language_director_ctor_code (self.swigCPtr_Language,
                                          Standard.system.Address (getCPtr (director_ctor_code)));
   ...
   begin
      ...
      swigg_c_import
        .set_Language_director_prot_ctor_code (self.swigCPtr_Language,
                                               Standard.system.Address (getCPtr (director_prot_ctor_code)));
