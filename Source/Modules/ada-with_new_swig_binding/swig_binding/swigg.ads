...
package swigg is
   ...
   line_number                             : aliased Integer;
   CPlusPlus                               : aliased Integer;
   Extend                                  : aliased Integer;
   Verbose                                 : aliased Integer;
   IsVirtual                               : aliased Integer;
   ImportMode                              : aliased Integer;
   NoExcept                                : aliased Integer;
   the_Abstract                            : aliased Integer;
   SmartPointer                            : aliased Integer;
   SwigRuntime                             : aliased Integer;
