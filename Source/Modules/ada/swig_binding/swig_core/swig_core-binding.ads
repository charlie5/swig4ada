...
package swig_Core.Binding is
   ...
   function NewSwigType
     (typecode : in interfaces.c.int) return swig_Core.Pointers
     .SwigType_Pointer;
   ...
   function SwigType_add_memberpointer
     (t    : in swig_Core.Pointers.SwigType_Pointer;
      qual : in DOHs.const_String_or_char_ptr.Item) return swig_Core.Pointers
     .SwigType_Pointer;
   ...
   function SwigType_add_array (t : in swig_Core.Pointers.SwigType_Pointer;
      size : in DOHs.const_String_or_char_ptr.Item) return swig_Core.Pointers
     .SwigType_Pointer;
   ...
   function SwigType_add_qualifier (t : in swig_Core.Pointers.SwigType_Pointer;
      qual : in DOHs.const_String_or_char_ptr.Item) return swig_Core.Pointers
     .SwigType_Pointer;
   ...
   function SwigType_add_function (t : in swig_Core.Pointers.SwigType_Pointer;
      parms : in swig_Core.Pointers.ParmList_Pointer) return swig_Core.Pointers
     .SwigType_Pointer;

   function SwigType_add_template (t : in swig_Core.Pointers.SwigType_Pointer;
      parms : in swig_Core.Pointers.ParmList_Pointer) return swig_Core.Pointers
     .SwigType_Pointer;
   ...
   function SwigType_function_parms
     (t              : in swig_Core.Pointers.SwigType_Pointer;
      file_line_node : in swig_Core.Pointers.Node_Pointer)
      return swig_Core.Pointers.ParmList_Pointer;
   ...
   procedure SwigType_push (t : in swig_Core.Pointers.SwigType_Pointer;
      s                       : in swig_Core.Pointers.String_Pointer);

   function SwigType_parmlist
     (p : in swig_Core.Pointers.SwigType_Pointer) return swig_Core.Pointers
     .List_Pointer;
   ...
   function SwigType_str (s : in swig_Core.Pointers.SwigType_Pointer;
      id : in DOHs.const_String_or_char_ptr.Item) return swig_Core.Pointers
     .String_Pointer;

   function SwigType_lstr (s : in swig_Core.Pointers.SwigType_Pointer;
      id : in DOHs.const_String_or_char_ptr.Item) return swig_Core.Pointers
     .String_Pointer;

   function SwigType_rcaststr (s : in swig_Core.Pointers.SwigType_Pointer;
      id : in DOHs.const_String_or_char_ptr.Item) return swig_Core.Pointers
     .String_Pointer;

   function SwigType_lcaststr (s : in swig_Core.Pointers.SwigType_Pointer;
      id : in DOHs.const_String_or_char_ptr.Item) return swig_Core.Pointers
     .String_Pointer;
   ...
   function SwigType_ispointer
     (t : in swig_Core.Pointers.SwigType_Pointer) return interfaces.c.int;
   ...
   function SwigType_check_decl (t : in swig_Core.Pointers.SwigType_Pointer;
   ...
   function SwigType_array_getdim (t : in swig_Core.Pointers.SwigType_Pointer;
      n : in interfaces.c.int) return swig_Core.Pointers.String_Pointer;

   procedure SwigType_array_setdim (t : in swig_Core.Pointers.SwigType_Pointer;
      n : in interfaces.c.int; rep : in DOHs.const_String_or_char_ptr.Item);
   ...
   function SwigType_default_create
     (ty : in swig_Core.Pointers.SwigType_Pointer) return swig_Core.Pointers
     .SwigType_Pointer;
   ...
   procedure SwigType_typename_replace
     (t   : in swig_Core.Pointers.SwigType_Pointer;
      pat : in swig_Core.Pointers.String_Pointer;
      rep : in swig_Core.Pointers.String_Pointer);

   function SwigType_remove_global_scope_prefix
     (t : in swig_Core.Pointers.SwigType_Pointer) return swig_Core.Pointers
     .SwigType_Pointer;

   function SwigType_alttype (t : in swig_Core.Pointers.SwigType_Pointer;
      ltmap : in interfaces.c.int) return swig_Core.Pointers.SwigType_Pointer;

   procedure SwigType_typesystem_init;

   function SwigType_typedef
     (the_type : in swig_Core.Pointers.SwigType_Pointer;
   ...
   procedure SwigType_inherit (subclass : in swig_Core.Pointers.String_Pointer;
      baseclass                         : in swig_Core.Pointers.String_Pointer;
      cast                              : in swig_Core.Pointers.String_Pointer;
      conversioncode : in swig_Core.Pointers.String_Pointer);

   function SwigType_issubtype
     (the_subtype : in swig_Core.Pointers.SwigType_Pointer;
      basetype    : in swig_Core.Pointers.SwigType_Pointer) return interfaces.c
     .int;

   procedure SwigType_scope_alias
     (aliasname : in swig_Core.Pointers.String_Pointer;
      t         : in swig_Core.Pointers.Typetab_Pointer);

   procedure SwigType_using_scope (t : in swig_Core.Pointers.Typetab_Pointer);

   procedure SwigType_new_scope (name : in DOHs.const_String_or_char_ptr.Item);

   procedure SwigType_inherit_scope
     (scope : in swig_Core.Pointers.Typetab_Pointer);

   function SwigType_pop_scope return swig_Core.Pointers.Typetab_Pointer;

   function SwigType_set_scope
     (h : in swig_Core.Pointers.Typetab_Pointer) return swig_Core.Pointers
     .Typetab_Pointer;
   ...
   procedure SwigType_attach_symtab
     (syms : in swig_Core.Pointers.Symtab_Pointer);

   procedure SwigType_remember (t : in swig_Core.Pointers.SwigType_Pointer);
   ...
   procedure SwigType_remember_mangleddata
     (mangled    : in swig_Core.Pointers.String_Pointer;
      clientdata : in DOHs.const_String_or_char_ptr.Item);

   procedure SwigType_emit_type_table
     (f_headers : in swig_Core.Pointers.File_Pointer;
      f_table   : in swig_Core.Pointers.File_Pointer);

   function SwigType_type
     (t : in swig_Core.Pointers.SwigType_Pointer) return interfaces.c.int;

   procedure Swig_symbol_print_tables
     (symtab : in swig_Core.Pointers.Symtab_Pointer);
   ...
   function Swig_symbol_getscopename return swig_Core.Pointers.String_Pointer;

   function Swig_symbol_qualifiedscopename
     (symtab : in swig_Core.Pointers.Symtab_Pointer) return swig_Core.Pointers
     .String_Pointer;
   ...
   function Swig_symbol_newscope return swig_Core.Pointers.Symtab_Pointer;

   function Swig_symbol_setscope
     (arg_1 : in swig_Core.Pointers.Symtab_Pointer) return swig_Core.Pointers
     .Symtab_Pointer;

   function Swig_symbol_getscope
     (symname : in DOHs.const_String_or_char_ptr.Item)
      return swig_Core.Pointers.Symtab_Pointer;

   function Swig_symbol_global_scope return swig_Core.Pointers.Symtab_Pointer;

   function Swig_symbol_current return swig_Core.Pointers.Symtab_Pointer;

   function Swig_symbol_popscope return swig_Core.Pointers.Symtab_Pointer;

   function Swig_symbol_add (symname : in DOHs.const_String_or_char_ptr.Item;
      node : in swig_Core.Pointers.Node_Pointer) return swig_Core.Pointers
     .Node_Pointer;
   ...
   function Swig_symbol_clookup
     (symname : in DOHs.const_String_or_char_ptr.Item;
      tab     : in swig_Core.Pointers.Symtab_Pointer) return swig_Core.Pointers
     .Node_Pointer;

   function Swig_symbol_clookup_no_inherit
     (name : in DOHs.const_String_or_char_ptr.Item;
      n    : in swig_Core.Pointers.Symtab_Pointer) return swig_Core.Pointers
     .Node_Pointer;
   ...
   procedure Swig_symbol_remove (node : in swig_Core.Pointers.Node_Pointer);

   procedure Swig_symbol_alias
     (aliasname : in DOHs.const_String_or_char_ptr.Item;
      tab       : in swig_Core.Pointers.Symtab_Pointer);

   procedure Swig_symbol_inherit (tab : in swig_Core.Pointers.Symtab_Pointer);

   function Swig_symbol_type_qualify
     (ty  : in swig_Core.Pointers.SwigType_Pointer;
      tab : in swig_Core.Pointers.Symtab_Pointer) return swig_Core.Pointers
     .SwigType_Pointer;
   ...
   function Swig_symbol_template_defargs
     (parms  : in swig_Core.Pointers.Parm_Pointer;
      targs  : in swig_Core.Pointers.Parm_Pointer;
      tscope : in swig_Core.Pointers.Symtab_Pointer;
      tsdecl : in swig_Core.Pointers.Symtab_Pointer) return swig_Core.Pointers
     .ParmList_Pointer;

   function Swig_symbol_template_deftype
     (the_type : in swig_Core.Pointers.SwigType_Pointer;
      tscope : in swig_Core.Pointers.Symtab_Pointer) return swig_Core.Pointers
     .SwigType_Pointer;

   function Swig_symbol_template_param_eval
     (p      : in swig_Core.Pointers.SwigType_Pointer;
      symtab : in swig_Core.Pointers.Symtab_Pointer) return swig_Core.Pointers
     .SwigType_Pointer;

   function ParmList_errorstr
     (arg_1 : in swig_Core.Pointers.ParmList_Pointer) return swig_Core.Pointers
     .String_Pointer;
   ...
   function Swig_name_mangle
     (s : in DOHs.const_String_or_char_ptr.Item) return swig_Core.Pointers
     .String_Pointer;

   function Swig_name_wrapper
     (fname : in DOHs.const_String_or_char_ptr.Item) return swig_Core.Pointers
     .String_Pointer;
   ...
   function Swig_name_get (nspace : in DOHs.const_String_or_char_ptr.Item;
      vname : in DOHs.const_String_or_char_ptr.Item) return swig_Core.Pointers
     .String_Pointer;
   ...
   procedure Swig_name_namewarn_add
     (prefix  : in swig_Core.Pointers.String_Pointer;
      name    : in swig_Core.Pointers.String_Pointer;
      decl    : in swig_Core.Pointers.SwigType_Pointer;
      namewrn : in swig_Core.Pointers.Hash_Pointer);
   ...
   procedure Swig_name_rename_add
     (prefix          : in swig_Core.Pointers.String_Pointer;
      ...
      decl            : in swig_Core.Pointers.SwigType_Pointer;
      namewrn         : in swig_Core.Pointers.Hash_Pointer;
      declaratorparms : in swig_Core.Pointers.ParmList_Pointer);

   procedure Swig_name_inherit (base : in swig_Core.Pointers.String_Pointer;
      derived                        : in swig_Core.Pointers.String_Pointer);

   function Swig_make_inherit_list
     (clsname         : in swig_Core.Pointers.String_Pointer;
      names           : in swig_Core.Pointers.List_Pointer;
      Namespaceprefix : in swig_Core.Pointers.String_Pointer)
      return swig_Core.Pointers.List_Pointer;

   procedure Swig_inherit_base_symbols
     (bases : in swig_Core.Pointers.List_Pointer);

   function Swig_need_protected
     (n : in swig_Core.Pointers.Node_Pointer) return interfaces.c.int;

   function Swig_need_redefined_warn (a : in swig_Core.Pointers.Node_Pointer;
      b                                 : in swig_Core.Pointers.Node_Pointer;
      InClass : in interfaces.c.int) return interfaces.c.int;

   function Swig_name_make (n : in swig_Core.Pointers.Node_Pointer;
      prefix                  : in swig_Core.Pointers.String_Pointer;
      cname                   : in DOHs.const_String_or_char_ptr.Item;
      decl                    : in swig_Core.Pointers.SwigType_Pointer;
      oldname : in swig_Core.Pointers.String_Pointer) return swig_Core.Pointers
     .String_Pointer;

   function Swig_name_warning (n : in swig_Core.Pointers.Node_Pointer;
      prefix                     : in swig_Core.Pointers.String_Pointer;
      name                       : in swig_Core.Pointers.String_Pointer;
      decl : in swig_Core.Pointers.SwigType_Pointer) return swig_Core.Pointers
     .String_Pointer;
   ...
   procedure Swig_name_object_set
     (namehash : in swig_Core.Pointers.Hash_Pointer;
      name     : in swig_Core.Pointers.String_Pointer;
      decl     : in swig_Core.Pointers.SwigType_Pointer;
   ...
   function Swig_name_object_get
     (namehash : in swig_Core.Pointers.Hash_Pointer;
      prefix   : in swig_Core.Pointers.String_Pointer;
      name     : in swig_Core.Pointers.String_Pointer;
      decl     : in swig_Core.Pointers.SwigType_Pointer) return DOHs.Pointers
     .DOH_Pointer;

   procedure Swig_name_object_inherit
     (namehash : in swig_Core.Pointers.Hash_Pointer;
      base     : in swig_Core.Pointers.String_Pointer;
      derived  : in swig_Core.Pointers.String_Pointer);

   procedure Swig_features_get (features : in swig_Core.Pointers.Hash_Pointer;
      prefix : in swig_Core.Pointers.String_Pointer;
      name : in swig_Core.Pointers.String_Pointer;
      decl : in swig_Core.Pointers.SwigType_Pointer;
      n                                  : in swig_Core.Pointers.Node_Pointer);

   procedure Swig_feature_set (features : in swig_Core.Pointers.Hash_Pointer;
      name : in DOHs.const_String_or_char_ptr.Item;
      decl : in swig_Core.Pointers.SwigType_Pointer;
      featurename : in DOHs.const_String_or_char_ptr.Item;
      value : in DOHs.const_String_or_char_ptr.Item;
      featureattribs                    : in swig_Core.Pointers.Hash_Pointer);
   ...
   procedure Swig_banner (f : in swig_Core.Pointers.File_Pointer);

   procedure Swig_banner_target_lang (f : in swig_Core.Pointers.File_Pointer;
   ...
   function Swig_new_subdirectory
     (basedirectory : in swig_Core.Pointers.String_Pointer;
      subdirectory  : in swig_Core.Pointers.String_Pointer)
      return swig_Core.Pointers.String_Pointer;
   ...
   procedure Swig_scopename_split (s : in swig_Core.Pointers.String_Pointer;
      prefix : in swig_Core.pointer_Pointers.String_Pointer_Pointer;
      last : in swig_Core.pointer_Pointers.String_Pointer_Pointer);
   ...
   procedure Swig_offset_string (s : in swig_Core.Pointers.String_Pointer;
      number                       : in interfaces.c.int);

   function Swig_pcre_version return swig_Core.Pointers.String_Pointer;
   ...
   procedure Swig_error_msg_format (format : in swig_Core.ErrorMessageFormat);

   procedure Swig_diagnostic (filename : in DOHs.const_String_or_char_ptr.Item;
      line : in interfaces.c.int; fmt : in interfaces.c.strings.chars_ptr);

   function Swig_stringify_with_location
     (object : in DOHs.Pointers.DOH_Pointer) return swig_Core.Pointers
     .String_Pointer;
   ...
   function Swig_cparm_name (p : in swig_Core.Pointers.Parm_Pointer;
      i : in interfaces.c.int) return swig_Core.Pointers.String_Pointer;

   function Swig_wrapped_var_type (t : in swig_Core.Pointers.SwigType_Pointer;
      varcref : in interfaces.c.int) return swig_Core.Pointers.String_Pointer;

   function Swig_cargs (w : in swig_Core.Wrapper.Pointer;
      l : in swig_Core.Pointers.ParmList_Pointer) return interfaces.c.int;

   function Swig_cresult (t : in swig_Core.Pointers.SwigType_Pointer;
      name                  : in DOHs.const_String_or_char_ptr.Item;
      decl : in DOHs.const_String_or_char_ptr.Item) return swig_Core.Pointers
     .String_Pointer;
   ...
   function Swig_cconstructor_call
     (name : in DOHs.const_String_or_char_ptr.Item) return swig_Core.Pointers
     .String_Pointer;
   ...
   function Swig_ref_call (n : in swig_Core.Pointers.Node_Pointer;
      lname : in swig_Core.Pointers.String_Pointer) return swig_Core.Pointers
     .String_Pointer;
   ...
   function Swig_cmemberset_call (name : in DOHs.const_String_or_char_ptr.Item;
      the_type : in swig_Core.Pointers.SwigType_Pointer;
      self                             : in swig_Core.Pointers.String_Pointer;
      varcref : in interfaces.c.int) return swig_Core.Pointers.String_Pointer;
   ...
   function Swig_add_extension_code (n : in swig_Core.Pointers.Node_Pointer;
      function_name                    : in swig_Core.Pointers.String_Pointer;
      parms : in swig_Core.Pointers.ParmList_Pointer;
      return_type : in swig_Core.Pointers.SwigType_Pointer;
      code                             : in swig_Core.Pointers.String_Pointer;
      cplusplus                        : in interfaces.c.int;
      self : in swig_Core.Pointers.String_Pointer) return interfaces.c.int;
   ...
   function Swig_MethodToFunction (n : in swig_Core.Pointers.Node_Pointer;
      nspace                         : in DOHs.const_String_or_char_ptr.Item;
      classname                      : in swig_Core.Pointers.String_Pointer;
      flags                          : in interfaces.c.int;
      director_type                  : in swig_Core.Pointers.SwigType_Pointer;
      is_director : in interfaces.c.int) return interfaces.c.int;

   function Swig_ConstructorToFunction (n : in swig_Core.Pointers.Node_Pointer;
      nspace : in DOHs.const_String_or_char_ptr.Item;
      classname : in swig_Core.Pointers.String_Pointer;
      none_comparison : in swig_Core.Pointers.String_Pointer;
      director_ctor : in swig_Core.Pointers.String_Pointer;
      cplus : in interfaces.c.int; flags : in interfaces.c.int;
      directorname : in swig_Core.Pointers.String_Pointer) return interfaces.c
     .int;

   function Swig_DestructorToFunction (n : in swig_Core.Pointers.Node_Pointer;
      nspace : in DOHs.const_String_or_char_ptr.Item;
      classname : in swig_Core.Pointers.String_Pointer;
      cplus                              : in interfaces.c.int;
      flags : in interfaces.c.int) return interfaces.c.int;

   function Swig_MembersetToFunction (n : in swig_Core.Pointers.Node_Pointer;
      classname                         : in swig_Core.Pointers.String_Pointer;
      flags : in interfaces.c.int) return interfaces.c.int;

   function Swig_MembergetToFunction (n : in swig_Core.Pointers.Node_Pointer;
      classname                         : in swig_Core.Pointers.String_Pointer;
      flags : in interfaces.c.int) return interfaces.c.int;

   function Swig_VargetToFunction (n : in swig_Core.Pointers.Node_Pointer;
      flags : in interfaces.c.int) return interfaces.c.int;

   function Swig_VarsetToFunction (n : in swig_Core.Pointers.Node_Pointer;
      flags : in interfaces.c.int) return interfaces.c.int;
   ...
   function Swig_directormap (n : in swig_Core.Pointers.Node_Pointer;
      the_type                  : in swig_Core.Pointers.String_Pointer)
      return swig_Core.Pointers.Node_Pointer;

   procedure Swig_typemap_init;

   procedure Swig_typemap_register
     (tmap_method : in DOHs.const_String_or_char_ptr.Item;
      pattern     : in swig_Core.Pointers.ParmList_Pointer;
      code        : in DOHs.const_String_or_char_ptr.Item;
      locals      : in swig_Core.Pointers.ParmList_Pointer;
      kwargs      : in swig_Core.Pointers.ParmList_Pointer);

   function Swig_typemap_copy
     (tmap_method : in DOHs.const_String_or_char_ptr.Item;
      srcpattern  : in swig_Core.Pointers.ParmList_Pointer;
      pattern     : in swig_Core.Pointers.ParmList_Pointer) return interfaces.c
     .int;
   ...
   function Swig_typemap_apply
     (srcpat  : in swig_Core.Pointers.ParmList_Pointer;
      destpat : in swig_Core.Pointers.ParmList_Pointer) return interfaces.c
     .int;
   ...
   function Swig_typemap_lookup
     (tmap_method : in DOHs.const_String_or_char_ptr.Item;
      ...
      f           : in swig_Core.Wrapper.Pointer) return swig_Core.Pointers
     .String_Pointer;
   ...
   function Swig_typemap_lookup_out
     (tmap_method : in DOHs.const_String_or_char_ptr.Item;
      ...
      actioncode  : in swig_Core.Pointers.String_Pointer)
      return swig_Core.Pointers.String_Pointer;
   ...
   procedure Swig_fragment_register
     (fragment : in swig_Core.Pointers.Node_Pointer);

   procedure Swig_fragment_emit (name : in swig_Core.Pointers.String_Pointer);

   function Swig_extend_hash return swig_Core.Pointers.Hash_Pointer;

   procedure Swig_extend_merge (cls : in swig_Core.Pointers.Node_Pointer;
      am                            : in swig_Core.Pointers.Node_Pointer);

   procedure Swig_extend_append_previous
     (cls : in swig_Core.Pointers.Node_Pointer;
      am  : in swig_Core.Pointers.Node_Pointer);
   ...
   function NewWrapper return swig_Core.Wrapper.Pointer;

   procedure DelWrapper (w : in swig_Core.Wrapper.Pointer);

   procedure Wrapper_compact_print_mode_set (flag : in interfaces.c.int);

   procedure Wrapper_pretty_print (str : in swig_Core.Pointers.String_Pointer;
      f                                : in swig_Core.Pointers.File_Pointer);

   procedure Wrapper_compact_print (str : in swig_Core.Pointers.String_Pointer;
      f                                 : in swig_Core.Pointers.File_Pointer);

   procedure Wrapper_print (w : in swig_Core.Wrapper.Pointer;
      f                       : in swig_Core.Pointers.File_Pointer);

   function Wrapper_add_local (w : in swig_Core.Wrapper.Pointer;
      name                       : in DOHs.const_String_or_char_ptr.Item;
      decl : in DOHs.const_String_or_char_ptr.Item) return interfaces.c.int;

   function Wrapper_add_localv (w : in swig_Core.Wrapper.Pointer;
      name : in DOHs.const_String_or_char_ptr.Item) return interfaces.c.int;

   function Wrapper_check_local (w : in swig_Core.Wrapper.Pointer;
      name : in DOHs.const_String_or_char_ptr.Item) return interfaces.c.int;

   function Wrapper_new_local (w : in swig_Core.Wrapper.Pointer;
      name                       : in DOHs.const_String_or_char_ptr.Item;
      decl : in DOHs.const_String_or_char_ptr.Item) return interfaces.c.strings
     .chars_ptr;

   function Wrapper_new_localv (w : in swig_Core.Wrapper.Pointer;
      name : in DOHs.const_String_or_char_ptr.Item) return interfaces.c.strings
     .chars_ptr;

   function Preprocessor_expr (s : in swig_Core.Pointers.String_Pointer;
   ...
   function Preprocessor_define (str : in DOHs.const_String_or_char_ptr.Item;
      swigmacro : in interfaces.c.int) return swig_Core.Pointers.Hash_Pointer;
   ...
   function Preprocessor_depend return swig_Core.Pointers.List_Pointer;

   procedure Preprocessor_expr_init;

   procedure Preprocessor_expr_delete;

   function checkAttribute (obj : in swig_Core.Pointers.Node_Pointer;
      name                      : in DOHs.const_String_or_char_ptr.Item;
      value : in DOHs.const_String_or_char_ptr.Item) return interfaces.c.int;

   procedure appendChild (node : in swig_Core.Pointers.Node_Pointer;
      child                    : in swig_Core.Pointers.Node_Pointer);

   procedure prependChild (node : in swig_Core.Pointers.Node_Pointer;
      child                     : in swig_Core.Pointers.Node_Pointer);

   procedure removeNode (node : in swig_Core.Pointers.Node_Pointer);

   function copyNode
     (node : in swig_Core.Pointers.Node_Pointer) return swig_Core.Pointers
     .Node_Pointer;

   procedure appendSibling (node : in swig_Core.Pointers.Node_Pointer;
      child                      : in swig_Core.Pointers.Node_Pointer);
   ...
   procedure Swig_restore (node : in swig_Core.Pointers.Node_Pointer);

   procedure Swig_print_tags (obj : in swig_Core.Pointers.File_Pointer;
      root                        : in swig_Core.Pointers.Node_Pointer);

   procedure Swig_print_tree (obj : in swig_Core.Pointers.Node_Pointer);

   procedure Swig_print_node (obj : in swig_Core.Pointers.Node_Pointer);
   ...
   function Swig_last_file return swig_Core.Pointers.String_Pointer;

   function Swig_search_path return swig_Core.Pointers.List_Pointer;
   ...
   function Swig_read_file
     (f : in swig.void_ptr) return swig_Core.Pointers.String_Pointer;
   ...
   function Swig_insert_file (name : in DOHs.const_String_or_char_ptr.Item;
      outfile : in swig_Core.Pointers.File_Pointer) return interfaces.c.int;
   ...
   procedure Swig_register_filebyname
     (filename : in DOHs.const_String_or_char_ptr.Item;
      outfile  : in swig_Core.Pointers.File_Pointer);

   function Swig_filebyname
     (filename : in DOHs.const_String_or_char_ptr.Item)
      return swig_Core.Pointers.File_Pointer;
   ...
   function c_to_doh_String
     (c_String : in interfaces.c.strings.chars_ptr) return swig_Core.Pointers
     .String_Pointer;

   function Node_to_CStr
     (node : in swig_Core.Pointers.Node_Pointer) return interfaces.c.strings
     .chars_ptr;

   function node_Type
     (node : in swig_Core.Pointers.Node_Pointer) return DOHs.Pointers
     .DOH_Pointer;
   ...
   function new_File (name : in swig_Core.Pointers.String_Pointer;
      mode : in interfaces.c.strings.chars_ptr) return swig_Core.Pointers
     .File_Pointer;

   procedure Print_to (Self : in swig_Core.Pointers.String_Pointer;
      the_Text              : in interfaces.c.strings.chars_ptr);

   procedure dump (from : in swig_Core.Pointers.File_Pointer;
      to                : in swig_Core.Pointers.File_Pointer);

   procedure close_File (Self : in swig_Core.Pointers.File_Pointer);

   procedure doh_replace_All (Self : in DOHs.Pointers.DOH_Pointer;
      Pattern                      : in swig_Core.Pointers.String_Pointer;
      Substitute                   : in swig_Core.Pointers.String_Pointer);

   procedure Swig_save_1 (name_Space : in interfaces.c.strings.chars_ptr;
      the_Node                       : in swig_Core.Pointers.Node_Pointer;
      Value                          : in interfaces.c.strings.chars_ptr);

   procedure Swig_require_2 (name_Space : in interfaces.c.strings.chars_ptr;
      the_Node                          : in swig_Core.Pointers.Node_Pointer;
      Value_1                           : in swig_Core.Pointers.String_Pointer;
      Value_2 : in swig_Core.Pointers.String_Pointer);

   procedure Wrapper_add_local_2 (the_Wrapper : in swig_Core.Wrapper.Pointer;
      Name : in swig_Core.Pointers.String_or_char_Pointer;
      Item_1 : in interfaces.c.strings.chars_ptr;
      Item_2 : in interfaces.c.strings.chars_ptr);

   function first_Child
     (Self : in swig_Core.Pointers.Node_Pointer) return swig_Core.Pointers
     .Node_Pointer;
