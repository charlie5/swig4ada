...
private
   ...
   pragma Import (CPP, IsVirtual, "_ZN12swigg_module9IsVirtualE");
   pragma Import (CPP, ImportMode, "_ZN12swigg_module10ImportModeE");
   pragma Import (CPP, NoExcept, "_ZN12swigg_module8NoExceptE");
   pragma Import (CPP, the_Abstract, "_ZN12swigg_module12the_AbstractE");
   pragma Import (CPP, SmartPointer, "_ZN12swigg_module12SmartPointerE");
   pragma Import (CPP, SwigRuntime, "_ZN12swigg_module11SwigRuntimeE");
