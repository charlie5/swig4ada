...
package swigg_module is
   ...
   type DohObjInfo_array is array (interfaces.C.Size_t range <>) of aliased swigg_module.DohObjInfo;

   -- String
   -- 
   subtype String is DOHs.DOH;

   type String_array is array (interfaces.C.Size_t range <>) of aliased swigg_module.String;

   -- Hash
   -- 
   subtype Hash is DOHs.DOH;

   type Hash_array is array (interfaces.C.Size_t range <>) of aliased swigg_module.Hash;

   -- List
   -- 
   subtype List is DOHs.DOH;

   type List_array is array (interfaces.C.Size_t range <>) of aliased swigg_module.List;

   -- String_or_char
   -- 
   subtype String_or_char is DOHs.DOH;

   type String_or_char_array is array (interfaces.C.Size_t range <>) of aliased swigg_module.String_or_char;

   -- File
   -- 
   subtype File is DOHs.DOH;

   type File_array is array (interfaces.C.Size_t range <>) of aliased swigg_module.File;

   -- Parm
   -- 
   subtype Parm is DOHs.DOH;

   type Parm_array is array (interfaces.C.Size_t range <>) of aliased swigg_module.Parm;

   -- ParmList
   -- 
   subtype ParmList is DOHs.DOH;

   type ParmList_array is array (interfaces.C.Size_t range <>) of aliased swigg_module.ParmList;

   -- Node
   -- 
   subtype Node is DOHs.DOH;

   type Node_array is array (interfaces.C.Size_t range <>) of aliased swigg_module.Node;

   -- Symtab
   -- 
   subtype Symtab is DOHs.DOH;

   type Symtab_array is array (interfaces.C.Size_t range <>) of aliased swigg_module.Symtab;

   -- Typetab
   -- 
   subtype Typetab is DOHs.DOH;

   type Typetab_array is array (interfaces.C.Size_t range <>) of aliased swigg_module.Typetab;

   -- SwigType
   -- 
   subtype SwigType is DOHs.DOH;

   type SwigType_array is array (interfaces.C.Size_t range <>) of aliased swigg_module.SwigType;
   ...
   type ErrorMessageFormat_array is array (interfaces.C.Size_t range <>) of aliased swigg_module.ErrorMessageFormat;
