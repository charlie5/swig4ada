...
package swigg.Language is
   ...
   function runtimeCode
     (Self : in swigg.Language.Item) return swigg.Pointers.String_Pointer;
   ...
   function getCurrentClass
     (Self : in swigg.Language.Item) return swigg.Pointers.Node_Pointer;

   function getClassName
     (Self : in swigg.Language.Item) return swigg.Pointers.String_Pointer;

   function getClassHash
     (Self : in swigg.Language.Item) return swigg.Pointers.Hash_Pointer;
