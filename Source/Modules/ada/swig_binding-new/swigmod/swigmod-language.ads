...
package swigmod.Language is
   ...
   function classLookup (Self :    access swigmod.Language.Item;
      s                       : in swigg_module.Pointers.SwigType_Pointer)
      return swigg_module.Pointers.Node_Pointer;

   function enumLookup (Self :    access swigmod.Language.Item;
      s                      : in swigg_module.Pointers.SwigType_Pointer)
      return swigg_module.Pointers.Node_Pointer;
   ...
   function runtimeCode
     (Self : access swigmod.Language.Item) return swigg_module.Pointers
     .String_Pointer;
   ...
   function getCurrentClass
     (Self : access swigmod.Language.Item'Class) return swigg_module.Pointers
     .Node_Pointer;
