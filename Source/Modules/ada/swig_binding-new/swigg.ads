...
package swigg is
   ...
   type String_array is array (interfaces.C.Size_t range <>) of aliased swigg.String;
   ...
   type DohObjInfo_array is array (interfaces.C.Size_t range <>) of aliased swigg.DohObjInfo;

   -- Hash
   -- 
   subtype Hash is swigg.DOH;

   type Hash_array is array (interfaces.C.Size_t range <>) of aliased swigg.Hash;

   -- List
   -- 
   subtype List is swigg.DOH;

   type List_array is array (interfaces.C.Size_t range <>) of aliased swigg.List;

   -- String_or_char
   -- 
   subtype String_or_char is swigg.DOH;

   type String_or_char_array is array (interfaces.C.Size_t range <>) of aliased swigg.String_or_char;

   -- File
   -- 
   subtype File is swigg.DOH;

   type File_array is array (interfaces.C.Size_t range <>) of aliased swigg.File;

   -- Parm
   -- 
   subtype Parm is swigg.DOH;

   type Parm_array is array (interfaces.C.Size_t range <>) of aliased swigg.Parm;

   -- ParmList
   -- 
   subtype ParmList is swigg.DOH;

   type ParmList_array is array (interfaces.C.Size_t range <>) of aliased swigg.ParmList;

   -- Node
   -- 
   subtype Node is swigg.DOH;

   type Node_array is array (interfaces.C.Size_t range <>) of aliased swigg.Node;

   -- Symtab
   -- 
   subtype Symtab is swigg.DOH;

   type Symtab_array is array (interfaces.C.Size_t range <>) of aliased swigg.Symtab;

   -- Typetab
   -- 
   subtype Typetab is swigg.DOH;

   type Typetab_array is array (interfaces.C.Size_t range <>) of aliased swigg.Typetab;

   -- SwigType
   -- 
   subtype SwigType is swigg.DOH;

   type SwigType_array is array (interfaces.C.Size_t range <>) of aliased swigg.SwigType;

   -- ErrorMessageFormat
   -- 
   type ErrorMessageFormat is (   EMF_STANDARD,
   EMF_MICROSOFT);

   for ErrorMessageFormat use (   EMF_STANDARD => 0,
   EMF_MICROSOFT => 1);

   pragma Convention (C, ErrorMessageFormat);


   type ErrorMessageFormat_array is array (interfaces.C.Size_t range <>) of aliased swigg.ErrorMessageFormat;
   ...
   the_PACKAGE : aliased constant interfaces.c.strings.chars_ptr := interfaces.c.strings.new_String ("swig");
   PACKAGE_BUGREPORT : aliased constant interfaces.c.strings.chars_ptr := interfaces.c.strings.new_String ("http://www.swig.org");
   PACKAGE_NAME : aliased constant interfaces.c.strings.chars_ptr := interfaces.c.strings.new_String ("swig");
   PACKAGE_STRING : aliased constant interfaces.c.strings.chars_ptr := interfaces.c.strings.new_String ("swig 1.3.36");
   PACKAGE_TARNAME : aliased constant interfaces.c.strings.chars_ptr := interfaces.c.strings.new_String ("swig");
   PACKAGE_VERSION : aliased constant interfaces.c.strings.chars_ptr := interfaces.c.strings.new_String ("1.3.36");
   STDC_HEADERS : constant  := 1;
   SWIG_CXX : aliased constant interfaces.c.strings.chars_ptr := interfaces.c.strings.new_String ("g++");
   SWIG_LIB : aliased constant interfaces.c.strings.chars_ptr := interfaces.c.strings.new_String ("/usr/local/share/swig/1.3.36");
   SWIG_LIB_WIN_UNIX : aliased constant interfaces.c.strings.chars_ptr := interfaces.c.strings.new_String ("\0");
   SWIG_PLATFORM : aliased constant interfaces.c.strings.chars_ptr := interfaces.c.strings.new_String ("x86_64-unknown-linux-gnu");
   VERSION : aliased constant interfaces.c.strings.chars_ptr := interfaces.c.strings.new_String ("1.3.36");
   SWIG_LANG : aliased constant interfaces.c.strings.chars_ptr := interfaces.c.strings.new_String ("-tcl");
   ...
   tab2 : aliased constant interfaces.c.strings.chars_ptr := interfaces.c.strings.new_String ("  ");
   tab4 : aliased constant interfaces.c.strings.chars_ptr := interfaces.c.strings.new_String ("    ");
   tab8 : aliased constant interfaces.c.strings.chars_ptr := interfaces.c.strings.new_String ("        ");
   SWIG_FILE_DELIMITER : aliased constant interfaces.c.strings.chars_ptr := interfaces.c.strings.new_String ("/");
