...
/* $Id: swigmod.h 961 2009-03-03 14:54:44Z krischik $ */
...
public:
  ...
  /* Allow any protected or private members also (for gnat)  RAK */
...
protected: // for Gnat
  int     overloading;
  bool    protected_and_private_Members_allowed;
...
extern "C" 
{
  Node*        Lang_CurrentClass ();
  String*      Lang_ClassName ();
  int          Lang_AddExtern ();
  int          Lang_ForceExtern ();
  //int          Lang_overloading ();

  Node*        Lang_first_nontemplate (Node*    n);
}
